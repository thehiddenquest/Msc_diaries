...
public class ExcelReader {
	...
	public String[][] readExcel(String filePath,String teacher) throws IOException {
	            ...
	            for (int i = row.getRowNum() + 1; i <= sheet.getLastRowNum(); i++) {
	                ...
	                if (nextRow != null) {
	                    ...
	                    data[rowIndex] = new String[] {
	                        ...
	                        full_marks.trim(), marks_obt.trim(), stream.trim(), sem.trim(), year.trim(), subject.trim(),teacher.trim()
	                    };
	                    rowIndex++;
