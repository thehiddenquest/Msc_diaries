	...
	private void initComponents() {
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
								...
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addComponent(jTextField4, javax.swing.GroupLayout.PREFERRED_SIZE, 276,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(85, 85, 85).addComponent(jLabel1)
								.addGap(40, 40, 40).addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE,
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(20, 20, 20).addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(45, 45, 45).addComponent(jButton1).addGap(24, 24, 24)));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout
						...
						.addGroup(jPanel2Layout.createSequentialGroup().addGap(82, 82, 82).addComponent(jPanel1,
		...
		if (fd.getFile() != null) {
			...
			if (fileName.endsWith(".pdf")) {
				...
				if (jTextField2.getText().equals("")) {
					...
					String[] opearation = { String.valueOf("2"), jTextField3.getText().trim(),
							jComboBox1.getSelectedItem().toString().trim(), jTextField2.getText().trim(),
							jTextField4.getText().trim() };
					ArrayList<MarksTO> retrieveMarks = marks.retriveDataBase(opearation);
					if (retrieveMarks != null) {
						pf.specificPDF(retrieveMarks, pdfPath, jTextField3.getText().trim().toUpperCase(),
								jComboBox1.getSelectedItem().toString().trim(), jTextField2.getText().trim().toUpperCase(),
								jTextField4.getText().trim().toUpperCase(),jTextField1.getText().trim().toUpperCase());
