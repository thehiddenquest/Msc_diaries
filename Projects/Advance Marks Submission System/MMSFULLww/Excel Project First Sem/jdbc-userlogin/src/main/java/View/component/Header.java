...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchText1.setText("University of Calcutta - Advanced Marks Submission System");
        searchText1.setFocusable(false);
        searchText1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setColor( Color.decode("#45C982"));
