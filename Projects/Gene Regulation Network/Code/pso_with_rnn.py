...
def plot_fitness(fitness_per_gene, max_iteration,cur):
    ...
    plt_filename = 'fitness_evolution_'+str(cur)+".png"
      ...
      for itr in range(max_iteration-1):
        ...
        for index,particle in enumerate(particles):
          ...
          if np.any(np.abs(particle.position) > 1):
              ...
              particle.velocity = np.zeros(num_gene+2)
...
#  num_particle = 3
  ...
  for cur in range(0,10):
    ...
    random.seed(7+cur)
    result_matrix, fitness_per_gene = PSO(num_gene, num_particle, max_iteration, max_inertia, min_inertia, accel_factor)
    ...
    print(f"Fitness evolution plot saved as fitness_evolution_{cur}.png")