...
# Main execution
num_files = 10
file_pattern = "result_matrix_5000_{}.csv"
eleventh_file = "actual_data.csv"
threshold = 0.8
...
try:
    ...
    thresholded_ground_truth = np.abs(ground_truth)
    ...
    if thresholded_matrix.shape == thresholded_ground_truth.shape:
        ...
        csv_filename = 'metrics_threshold_'+str(threshold)+".csv"
        ...
        cm_filename = 'confusion_matrix_threshold_'+str(threshold)+'.png'
