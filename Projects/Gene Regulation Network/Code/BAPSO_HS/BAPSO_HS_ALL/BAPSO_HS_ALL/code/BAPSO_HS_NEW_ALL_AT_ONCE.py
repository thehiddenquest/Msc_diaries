...
if __name__ == '__main__':
    ...
    for cur in range (10):
        ...
        csv_filename = "FINAL_YEAR_PROJECT/GRN_Code/BAPSO_HS_NEW/RUN_5/result_matrix_HS_BAPSO"+"_"+str(cur)+"_"+str(Iteration)+"_"+".csv"
        ...
        for gene in range(num_gene):
            ...
            plt.legend()
        image_file_name = "FINAL_YEAR_PROJECT/GRN_Code/BAPSO_HS_NEW/RUN_5/MSE_Curve_HS_BAPSO_"+str(cur)+"_"+str(Iteration)+".png"
...
for fi in [0.8, 0.9, 1]:
    ...
    for result_set in range(Result_sets):
        rs = np.array(pd.read_csv(f'FINAL_YEAR_PROJECT/GRN_Code/BAPSO_HS_NEW/RUN_5/result_matrix_HS_BAPSO_{result_set}_{Iteration}_.csv', sep=','))
    ...
    print("G : ",G)
    G = np.where(G >= fi,1,0)
    actual_result = np.array(pd.read_csv(f'FINAL_YEAR_PROJECT/GRN_Code/BAPSO_HS_NEW/actual_data.csv', sep=','))
    print("G : ",G)
    ...
    filename = 'FINAL_YEAR_PROJECT/GRN_Code/BAPSO_HS_NEW/RUN_5/Result_set_of_BAPSO_HS_fi_is_'+str(fi)+'_Iteration_'+str(Iteration)+'_Gene_'+str(num_gene)+'_.csv'
